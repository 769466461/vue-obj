<template>
  ...
  <header data-am-widget="header"
      ...
      <div class="am-header-left am-header-nav ">
          <a class="iconfont pet_head_jt_ico" @click="goback">&#xe601;</a>
      </div>
...
<div class="pet_hd_con_head"><img src="img/z1.jpg" alt=""></div>
  ...
  <div class="pet_article_user_time pet_hd_con_time"><i class="iconfont">&#xe617;</i>2015年10月26日 9:00 ～ 2015年10月28日 17:30</div>
  <div class="pet_article_user_time pet_hd_con_map"><i class="iconfont">&#xe632;</i>北京市海淀区成府路28号 优盛大厦B座8层</div>
  <div class="pet_article_user_time pet_hd_con_map"><i class="iconfont">&#xe615;</i>限额：50 人</div>
  <div class="pet_hd_con_gp">
    <div class="pet_hd_con_gp_title">坐席购买</div>
    <div class="pet_hd_con_gp_list">
      <span><i>￥500</i>标准票</span>
    ...
    <div class="pet_hd_con_gp_list_xl">订购数量：
      <select name="">
...
大会将围绕“技术创新助力互联网+时代”的主题，不仅会把美国 Ignite 的精彩内容、前瞻技术与创新、行业顶尖技术大牛带到中国，还会把中国本土客户与合作伙伴经典案例和解决方案、科技创新力量、行业大咖搬上中国Ignite的舞台。
活动中还精心安排了涵盖几乎微软所有产品线的150多节技术精讲及动手试验室的课程，势必将为参会者提供一场技术与创新的饕餮盛宴！</p>
 <div class="pet_hd_con_gp_list_nr_tag">课程主题</div>
    <p>参与 Microsoft Ignite China 微软技术大会，您可零距离聆听十二大精彩课程主题中的一百余场微软最新技术相关的重量级课程，率先体验到微软最新技术及最新解决方案的实践分享。</p>
    <p><img src="img/aa1.jpg" alt=""></p>
   <div class="pet_hd_con_gp_list_nr_tag">课程日程</div>
    <p><img src="img/aa2.jpg" alt=""></p>
       <div class="pet_hd_con_gp_list_nr_tag">演讲嘉宾</div>
    <p><img src="img/aa3.jpg" alt=""></p>
  </div>
